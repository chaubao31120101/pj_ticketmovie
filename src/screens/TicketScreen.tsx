...
import {Text,View,StyleSheet,StatusBar,ImageBackground,Image,
} from 'react-native';
import EncryptedStorage from 'react-native-encrypted-storage';
import AppHeader from '../components/AppHeader';
import {BORDERRADIUS,COLORS,FONTFAMILY,FONTSIZE,SPACING,
} from '../theme/theme';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.ticketContainer}>
                <ImageBackground
                    ...
                    <LinearGradient
                        colors={[COLORS.OrangeRGBA0, COLORS.BlackRGB10]}
